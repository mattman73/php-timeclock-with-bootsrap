...
echo '    <!-- Logo -->
    <a href="clockinout.php" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b> </b><i class="fa fa-clock-o"></i></span>
...
//echo "
//               <li><a href='clockinout.php'><i class='fa fa-home'></i> Home</a></li>
//            
//               <li><a href='login.php?login_action=admin'><i class='fa fa-globe'></i> Administration</a></li>";

if ($use_reports_password == "yes") {
    // removed as not wanted on clocking in page.
    //echo "<li><a href='login.php?login_action=reports'><i class='fa fa-globe'></i> Reports</a></li>";
